 ...
 * UTC (GMT) time via Julian Date Number. The
...
public class TimeStamp implements Comparator<TimeStamp>, Comparable<TimeStamp>,
	 ...
	 * "which gives a long ambiguity period of 27.4 years". (NASA codes PB-1,
	 * PB-4 used a 3-digit day-of-year count.) Only whole days are represented.
	 * Time of day is expressed by a count of seconds of a day, plus optional
	 * milliseconds, microseconds and nanoseconds in separate fields. Later
	 * PB-5J was introduced which increased the TJD field to 16 bits, allowing
	 * values up to 65535, which will occur in the year 2147. There are five
	 * digits recorded after TJD 9999.
	 * 
	 * @return
	 */
